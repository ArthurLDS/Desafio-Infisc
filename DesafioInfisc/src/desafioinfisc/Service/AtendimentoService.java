...
/**
 * Esta classe é um "Serviço" do objeto Atendimento, responsável por buscasr os dados referentes aos
 * atendimentos a partir da leitura de um arquivo e então construir a
 * representação destas informações em Classes Java. Também é responsável por
 * manipular os dados referentes à Atendimento, com buscas apartir de filtragens
 * específicas.
 *
 * @author Arthur
 *
